...
def process_dataset(root_dir, features_to_extract):
    """
        ...
        for file in os.listdir(genre_dir):
            ...
            if file.endswith('.mp3') or file.endswith('.wav') or file.endswith('.au'):
                ...
                for feature in features_to_extract:
                    extracted_feature = extract_features(file_path, feature)
...
root_dir = 'data/train'
features_to_extract = ['mfcc', 'spectral_centroid', 'spectral_flatness', 'chroma_stft', 'zero_crossing']
features, labels = process_dataset(root_dir, features_to_extract)
